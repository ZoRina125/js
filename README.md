...
1. Создаем файл `main.js` для размещения кода.
2. Создаем массив объектов с транзакциями. Каждая транзакция содержит следующие свойства:
...
<img width="1267" height="907" alt="image" src="https://github.com/user-attachments/assets/c47f2056-43ce-48a9-a835-fbb76ffcc411" />


### Шаг 2. Реализация функций для анализа транзакций

Реализуем следующие функции для анализа транзакций.
...
1. Создаем массив транзакций и протестируйте все функции.
2. Выводим результаты в консоль.
3. Проверяем работу функций на различных наборах данных.
4. Проверяем работу функций на пустом массиве транзакций _[extra]_.
5. Проверяем работу функций на массиве транзакций с одной транзакцией _[extra]_.
